...
In R, stepwise adds and removes predictors until AIC is minimized. AIC balances two factors: model fit (better fit → lower AIC) AND model simplicity (fewer parameters → lower AIC)

Note: Becuase it uses AIC, I cannot set my alpha_1 or alpha_2 levels like we talked about in class. 
